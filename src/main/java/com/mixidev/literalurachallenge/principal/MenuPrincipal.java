...
import com.mixidev.literalurachallenge.modelos.DatosLibro;
import com.mixidev.literalurachallenge.modelos.DatosLibros;
...
import com.mixidev.literalurachallenge.servicios.ApiRequest;
import com.mixidev.literalurachallenge.servicios.DataConversion;
...
public class MenuPrincipal {
    ...
    private MostrarTerm mostrarTerm = new MostrarTerm();
    ...
    public Autor searchOrSaveAuthor(DatosLibro libro) {
        ...
        if (!autorBuscado.isPresent()) {
            ...
            System.out.println("Autor registrado y guardado!");
        } else {
            authorToSave = autorBuscado.get();
            System.out.println("Autor ya registrado en la BD!");
        }
        return authorToSave;
    ...
    public void searchABookByTitle() {
        ...
        String message = "Introduce el título del libro a buscar: ";
